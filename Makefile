#############################################################################
# Makefile for building: TuringMachine
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  TuringMachine.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile TuringMachine.pro
#############################################################################
...
CXXFLAGS      = -pipe -g -std=c++1y -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -Iinclude -isystem /usr/include/qt -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = TuringMachine1.0.0
DISTDIR = /home/tomasz/Moje\ projekty/TuringMachine/.tmp/TuringMachine1.0.0
LINK          = g++
LFLAGS        = 
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		TuringMachine.pro include/LazyInitializator.h \
		...
		include/TMTape.h \
		include/TMTuringMachine.h main.cpp \
		src/TMAlphabet.cpp \
		src/TMAPI.cpp \
		src/TMCommandParser.cpp \
		src/TMControlGraph.cpp \
...
Makefile: TuringMachine.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile TuringMachine.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/LazyInitializator.h include/TMAlphabet.h include/TMAPI.h include/TMCommand.h include/TMCommandParser.h include/TMControlGraph.h include/TMExceptions.h include/TMFileParser.h include/TMHead.h include/TMHeadMoveType.h include/TMStateWatcher.h include/TMStringCharPair.h include/TMTape.h include/TMTuringMachine.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/TMAlphabet.cpp src/TMAPI.cpp src/TMCommandParser.cpp src/TMControlGraph.cpp src/TMFileParser.cpp src/TMStateWatcher.cpp src/TMTape.cpp src/TMTuringMachine.cpp $(DISTDIR)/
...
main.o: main.cpp include/TMAPI.h \
...
TMAlphabet.o: src/TMAlphabet.cpp include/TMAlphabet.h \
		include/TMExceptions.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TMAlphabet.o src/TMAlphabet.cpp

TMAPI.o: src/TMAPI.cpp include/TMAPI.h \
		include/TMTuringMachine.h \
		include/TMTape.h \
		include/TMHead.h \
		include/TMExceptions.h \
		...
		include/TMStateWatcher.h \
		include/LazyInitializator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TMAPI.o src/TMAPI.cpp

TMCommandParser.o: src/TMCommandParser.cpp include/TMCommandParser.h \
		include/TMCommand.h \
		include/TMHeadMoveType.h \
		include/TMExceptions.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TMCommandParser.o src/TMCommandParser.cpp

TMControlGraph.o: src/TMControlGraph.cpp include/TMControlGraph.h \
		include/TMCommand.h \
		include/TMHeadMoveType.h \
		include/TMStringCharPair.h \
		include/TMExceptions.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TMControlGraph.o src/TMControlGraph.cpp

TMFileParser.o: src/TMFileParser.cpp include/TMFileParser.h \
		include/TMStateWatcher.h \
		include/LazyInitializator.h \
		include/TMExceptions.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TMFileParser.o src/TMFileParser.cpp

TMStateWatcher.o: src/TMStateWatcher.cpp include/TMStateWatcher.h \
		include/LazyInitializator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TMStateWatcher.o src/TMStateWatcher.cpp

TMTape.o: src/TMTape.cpp include/TMTape.h \
		include/TMHead.h \
		include/TMExceptions.h \
		include/TMHeadMoveType.h \
		include/TMAlphabet.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TMTape.o src/TMTape.cpp

TMTuringMachine.o: src/TMTuringMachine.cpp include/TMTuringMachine.h \
		include/TMTape.h \
		include/TMHead.h \
		include/TMExceptions.h \
		include/TMHeadMoveType.h \
		...
		include/TMControlGraph.h \
		include/TMStringCharPair.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TMTuringMachine.o src/TMTuringMachine.cpp
